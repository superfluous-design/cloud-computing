...
import { applyFactGroups, factsIntersect, getFactsGroupForEventArgs, validateFacts, } from './facts.js';
...
export const rebaseEvents = ({ rebaseFn, pendingLocalEvents, newRemoteEvents, currentFactsSnapshot, clientId, sessionId, }) => {
    ...
    const { rebasedLocalEvents } = rebaseFn({
        ...
        validate: ({ rebasedLocalEvents, eventDefs }) => validateFacts({
            factGroups: rebasedLocalEvents.map((event) => getFactsGroupForEventArgs({
