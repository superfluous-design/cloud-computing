...
export declare const fromSubscriptionRef: <A>(ref: SubscriptionRef.SubscriptionRef<A>) => Subscribable<A>;
/**
 * @since 2.0.0
...
export declare const never: Subscribable<never, never, never>;
