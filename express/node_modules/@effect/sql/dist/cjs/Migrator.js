...
exports.make = exports.fromGlob = exports.fromBabelGlob = exports.MigrationError = void 0;
...
const make = ({
  ...
  const run = Effect.gen(function* () {
    ...
    yield* (0, _Function.pipe)(Effect.forEach(required, ([id, name, effect]) => Effect.logDebug(`Running migration`).pipe(Effect.zipRight(runMigration(id, name, effect)), Effect.annotateLogs("migration_id", String(id)), Effect.annotateLogs("migration_name", name)), {
      discard: true
    }));
