 ...
 * @category models
 */
export interface Rpc<in out Tag extends string, out Payload extends AnyStructSchema = Schema.Struct<{}>, out Success extends Schema.Schema.Any = typeof Schema.Void, out Error extends Schema.Schema.All = typeof Schema.Never, out Middleware extends RpcMiddleware.TagClassAny = never> extends Pipeable {
 ...
 * @category models
 */
export type ToHandlerFn<Current extends Any, R = any> = (payload: Payload<Current>, headers: Headers) => ResultFrom<Current, R> | Fork<ResultFrom<Current, R>>;
/**
 * @since 1.0.0
 * @category models
 */
